...
public class MainITest extends BaseIdentityManagerITest {
    ...
    public void configureWhenTheUserExpectOk() {
        ...
        String actual = call("common/configure_dfx_project", "identity_manager", user, user, TTL, TTL_REFRESH, WHITELISTED_PHONE_NUMBERS, user);
    ...
    public void configureWhenOtherUserExpectFail() {
        ...
        var user = call("common/get_principal").trim();
        String actual = call("common/configure_dfx_project", "identity_manager", user, user, TTL, TTL_REFRESH, WHITELISTED_PHONE_NUMBERS, 0, BACKUP_CANISTER_ID, BACKUP_CANISTER_ID);
