...
public class BaseIdentityManagerITest extends BaseDFXITest {
    ...
    public void initDfxProject() {
        ...
        do {
            ...
            identity_manager = call("common/configure_dfx_project", "identity_manager", KEY, ROOT_IDENTITY, TTL, TTL_REFRESH, WHITELISTED_PHONE_NUMBERS, getHeartBeatPeriod(), BACKUP_CANISTER_ID, WHITELISTED_CANISTERS );
            identity_manager_replica = call("common/configure_dfx_project", "identity_manager_replica", KEY, ROOT_IDENTITY, TTL, TTL_REFRESH, WHITELISTED_PHONE_NUMBERS, DISABLED_HEARTBEAT, BACKUP_CANISTER_ID, WHITELISTED_CANISTERS);
            if (++i >= DEFAULT_TRIES)
                System.exit(1);
