...
async fn test_ap_e2e() {
    ...
    let ap = AccessPointRequest { pub_key: Principal::self_authenticating(pk.clone()).to_text(), icon: "".to_string(), device: "".to_string(), browser: "".to_string(), device_type: DeviceType::Email, credential_id: None };
