...
describe("ICRC1 canister Storage", () => {
    ...
    it("Store/retrieve canister id", async function () {
        ...
        await dfx.icrc1.actor.store_icrc1_canister(canister_id);
        await dfx.icrc1.actor.store_icrc1_canister(one_more_canister_id);
        let canisters = await dfx.icrc1.actor.get_canisters_by_root(dfx.user.identity.getPrincipal().toText()) as string[];
