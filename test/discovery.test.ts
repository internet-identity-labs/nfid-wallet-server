...
describe("DiscoveryService", () => {
  describe("getApps", () => {
    it("should enrich apps with url, name, icon and desc", async () => {
      ...
      expect(apps).to.deep.equal([
        {
          ...
          data: {
            ...
            icon: "https://nfid.one/assets/icons/apple-touch-icon.png",
        ...
        },
        {
          ...
          data: {
            ...
            icon: "https://kongswap.io/apple-touch-icon.png",
        ...
        },
        {
          ...
          data: {
            ...
            icon: "https://atomicwallet.io/images/logo.ico",
