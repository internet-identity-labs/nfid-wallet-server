...
export interface _SERVICE {
  ...
  get_principal: (arg_0: UserNumber, arg_1: FrontendHostname) => Promise<Principal>;
  ...
  register: (arg_0: DeviceData, arg_1: ChallengeResult) => Promise<RegisterResponse>;
  remove: (arg_0: UserNumber, arg_1: DeviceKey) => Promise<undefined>;
  stats: () => Promise<InternetIdentityStats>;
  update: (arg_0: UserNumber, arg_1: DeviceKey, arg_2: DeviceData) => Promise<undefined>;
