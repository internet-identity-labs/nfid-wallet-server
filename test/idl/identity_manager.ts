...
export interface _SERVICE {
  ...
  create_access_point: ActorMethod<[AccessPointRequest], HTTPAccessPointResponse>;
  ...
  remove_access_point: ActorMethod<[AccessPointRemoveRequest], HTTPAccessPointResponse>;
  ...
  sync_recovery_phrase_from_internet_identity: ActorMethod<[bigint], HTTPAccountResponse>;
  update_2fa: ActorMethod<[boolean], AccountResponse>;
  get_root_by_principal: ActorMethod<[string], [[] | [string]]>;
  update_access_point: ActorMethod<[AccessPointRequest], HTTPAccessPointResponse>;
