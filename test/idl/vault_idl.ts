export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    approve_transaction: IDL.Func([TransactionApproveRequest], [Transaction], []),
    get_all_json: IDL.Func([IDL.Nat32, IDL.Nat32, Backup], [IDL.Text], ['query']),
    ...
    register_transaction: IDL.Func([TransactionRegisterRequest], [Transaction], []),
